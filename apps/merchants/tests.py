...
#     @patch("apps.paystack.views.PaymentInitializationView.send_initiate_payment_request_to_paygate")
...
#         transaction.products_ordered.set([ordered_product1, ordered_product2])
